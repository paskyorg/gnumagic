...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@ayuntamiento.svq";
    ...
    * @var string
    */
	protected $baseDn = "OU=Ayuntamiento de Sevilla,DC=ayuntamiento,DC=svq"; 
    ...
    * @var array
    */
    protected $domainControllers = array("grosso.ayuntamiento.svq", "andalucia.ayuntamiento.svq");
    ...
    * @var string
    */
	protected $adminUsername = "consigna";
    protected $adminPassword = "powerpoiconsigna";
